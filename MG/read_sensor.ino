void readSensor()
{
  ...
  if (dataAvailable == true) {
    ...
    flow_rate = result2/10;
    temperature = result3/10.0;
    byte to_lcd[12] = { reading[0], reading[1], reading[2], reading[3], reading[4], reading[5], reading[6], reading[7], reading[8], reading[9], reading[10], reading[11] }; // to sensor lcd
  ...
  //Serial.println("flow = " + String(flow_rate) + "%");
